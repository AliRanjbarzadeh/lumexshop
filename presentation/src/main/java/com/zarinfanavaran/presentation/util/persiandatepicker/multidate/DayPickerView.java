...
import com.zarinfanavaran.presentation.util.persiandatepicker.multidate.MultiDatePickerDialog.OnDateChangedListener;
...
//        }
    ...
    private static String getMonthAndYearString(MonthAdapter.CalendarDay day) {
        ...
        String sbuf = "";
        sbuf += mPersianCalendar.getPersianMonthName();
        sbuf += " ";
        sbuf += mPersianCalendar.getPersianYear();
        return sbuf;
    }
