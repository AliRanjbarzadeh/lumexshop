 ...
 */
class RetryDialog(context: Context, private val retryCallback: RetryCallback, isShowCancel: Boolean = true) {
	private var mDialog: MaterialDialog = MaterialDialog(context)
			.title(R.string.retry_dialog_title)
			.message(R.string.retry_dialog_message)
			.cancelable(false)
			.noAutoDismiss()
